...
class BancoView:
    """Vista principal de la aplicación bancaria"""
    ...
    def crear_interfaz(self):
        ...
        # ===== SECCIÓN SUPERIOR: GESTIÓN DE CLIENTES =====
        ...
        # Dividir en 3 columnas: Ahorro, Corriente, CDT
        ...
        # ===== SECCIÓN INFERIOR: RESUMEN Y SIMULACIÓN =====
    ...
    def seleccionar_cliente(self, event=None):
        """Selecciona un cliente del combobox"""
        seleccion = self.combo_clientes.get()
        if seleccion:
            # Extraer la cédula (formato: "Nombre (CC: 12345)")
    ...
    def cerrar_cdt(self):
        ...
        # Extraer el ID del CDT del texto seleccionado
    ...
    def actualizar_combo_clientes(self):
        ...
        valores = [str(cliente) for cliente in clientes]
        self.combo_clientes['values'] = valores
        
        # Seleccionar el último creado
        if valores:
    ...
    def actualizar_vista(self):
        ...
        self.label_info_cliente.config(text=self.controller.obtener_info_cliente())
        ...
        # Actualizar lista de CDTs
        self.listbox_cdts.delete(0, tk.END)
        cdts = self.controller.obtener_cdts()
        for cdt in cdts:
            texto = f"CDT #{cdt.id}: ${cdt.get_saldo():,.2f} ({cdt.tasa_interes*100:.2f}%)"
    ...
    def agregar_mensaje(self, mensaje):
        ...
        self.text_historial.see(tk.END)  # Scroll automático
